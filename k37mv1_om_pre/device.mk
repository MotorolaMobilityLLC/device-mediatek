...
PRODUCT_COPY_FILES += device/mediatek/k37mv1_om_pre/media_codecs_mediatek_video_gmo.xml:system/etc/media_codecs_mediatek_video.xml:mtk
PRODUCT_COPY_FILES += device/mediatek/k37mv1_om_pre/mtk_omx_core_gmo.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk

endif


# PRODUCT_COPY_FILES += device/mediatek/k37mv1_om_pre/egl.cfg:$(TARGET_COPY_OUT_VENDOR)/lib/egl/egl.cfg:mtk
# PRODUCT_COPY_FILES += device/mediatek/k37mv1_om_pre/ueventd.mt6735.rc:root/ueventd.mt6735.rc

PRODUCT_COPY_FILES += device/mediatek/k37mv1_om_pre/factory_init.project.rc:root/factory_init.project.rc
PRODUCT_COPY_FILES += device/mediatek/k37mv1_om_pre/init.project.rc:root/init.project.rc
PRODUCT_COPY_FILES += device/mediatek/k37mv1_om_pre/meta_init.project.rc:root/meta_init.project.rc

ifeq ($(MTK_SMARTBOOK_SUPPORT),yes)
PRODUCT_COPY_FILES += device/mediatek/k37mv1_om_pre/sbk-kpd.kl:system/usr/keylayout/sbk-kpd.kl:mtk \
                      device/mediatek/k37mv1_om_pre/sbk-kpd.kcm:system/usr/keychars/sbk-kpd.kcm:mtk
endif
...
#PRODUCT_COPY_FILES += device/mediatek/$(MTK_TARGET_PROJECT)/MT6735_Android_scatter.txt:MT6735_Android_scatter.txt
...
ifeq ($(TARGET_BUILD_VARIANT),eng)
    PRODUCT_COPY_FILES += device/mediatek/k37mv1_om_pre/thermal_eng.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/thermal.conf:mtk
else
    PRODUCT_COPY_FILES += device/mediatek/k37mv1_om_pre/thermal.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/thermal.conf:mtk
endif
PRODUCT_COPY_FILES += device/mediatek/k37mv1_om_pre/ht120.mtc:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/.ht120.mtc:mtk
...
PRODUCT_COPY_FILES += device/mediatek/k37mv1_om_pre/android.hardware.telephony.gsm.xml:system/etc/permissions/android.hardware.telephony.gsm.xml
...
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/k37mv1_om_pre/factory/res/sound/testpattern1.wav:$(TARGET_COPY_OUT_VENDOR)/res/sound/testpattern1.wav:mtk
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/k37mv1_om_pre/factory/res/sound/ringtone.wav:$(TARGET_COPY_OUT_VENDOR)/res/sound/ringtone.wav:mtk

# Keyboard layout
PRODUCT_COPY_FILES += device/mediatek/mt6735/ACCDET.kl:system/usr/keylayout/ACCDET.kl:mtk
PRODUCT_COPY_FILES += device/mediatek/k37mv1_om_pre/mtk-kpd.kl:system/usr/keylayout/mtk-kpd.kl:mtk

# Microphone
PRODUCT_COPY_FILES += device/mediatek/k37mv1_om_pre/android.hardware.microphone.xml:system/etc/permissions/android.hardware.microphone.xml

# Camera
PRODUCT_COPY_FILES += device/mediatek/k37mv1_om_pre/android.hardware.camera.xml:system/etc/permissions/android.hardware.camera.xml

# Audio Policy
PRODUCT_COPY_FILES += device/mediatek/k37mv1_om_pre/audio_policy.conf:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy.conf:mtk

#Images for LCD test in factory mode
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/k37mv1_om_pre/factory/res/images/lcd_test_00.png:$(TARGET_COPY_OUT_VENDOR)/res/images/lcd_test_00.png:mtk
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/k37mv1_om_pre/factory/res/images/lcd_test_01.png:$(TARGET_COPY_OUT_VENDOR)/res/images/lcd_test_01.png:mtk
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/k37mv1_om_pre/factory/res/images/lcd_test_02.png:$(TARGET_COPY_OUT_VENDOR)/res/images/lcd_test_02.png:mtk

#media_codecs.xml for video codec support
PRODUCT_COPY_FILES += device/mediatek/k37mv1_om_pre/media_codecs.xml:system/etc/media_codecs.xml:mtk
PRODUCT_COPY_FILES += device/mediatek/k37mv1_om_pre/media_codecs_performance.xml:system/etc/media_codecs_performance.xml:mtk
ifneq ($(MTK_BASIC_PACKAGE), yes)
    ifeq ($(strip $(MTK_AUDIO_CODEC_SUPPORT_TABLET)), yes)
        PRODUCT_COPY_FILES += device/mediatek/k37mv1_om_pre/media_codecs_mediatek_audio_tablet.xml:system/etc/media_codecs_mediatek_audio.xml:mtk
    else
        PRODUCT_COPY_FILES += device/mediatek/k37mv1_om_pre/media_codecs_mediatek_audio_phone.xml:system/etc/media_codecs_mediatek_audio.xml:mtk
    endif
else
    PRODUCT_COPY_FILES += device/mediatek/k37mv1_om_pre/media_codecs_mediatek_audio_basic.xml:system/etc/media_codecs_mediatek_audio.xml:mtk
endif
PRODUCT_COPY_FILES += device/mediatek/k37mv1_om_pre/media_codecs_mediatek_video.xml:system/etc/media_codecs_mediatek_video.xml:mtk
PRODUCT_COPY_FILES += device/mediatek/k37mv1_om_pre/mtk_omx_core.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk
...
DEVICE_PACKAGE_OVERLAYS += device/mediatek/k37mv1_om_pre/overlay

...
$(call inherit-product, device/mediatek/k37mv1_om_pre/device.mk)
...
PRODUCT_NAME := full_k37mv1_om_pre
PRODUCT_DEVICE := k37mv1_om_pre
PRODUCT_MODEL := k37mv1_om_pre
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= k37mv1_om_pre_debug_defconfig
else
KERNEL_DEFCONFIG ?= k37mv1_om_pre_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= k37mv1_om_pre
LK_PROJECT ?= k37mv1_om_pre
TRUSTY_PROJECT ?= k37mv1_om_pre

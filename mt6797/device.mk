...
PRODUCT_PACKAGES += audio.usb.mt6797
PRODUCT_PACKAGES += audio.usb.mt6797m
...
PRODUCT_PACKAGES += audio.r_submix.mt6797m
PRODUCT_PACKAGES += audio.r_submix.mt6797
PRODUCT_PACKAGES += libaudio.usb.default
...
PRODUCT_PACKAGES += power.mt6797
PRODUCT_PACKAGES += thermal.mt6797
...
ifeq ($(strip $(MTK_GPU_SUPPORT)), yes)
  ifeq ($(MTK_PLATFORM),$(filter $(MTK_PLATFORM),MT6797))
    ...
    PRODUCT_COPY_FILES += frameworks/native/data/etc/android.hardware.vulkan.version-1_0_3.xml:system/etc/permissions/android.hardware.vulkan.version.xml
    PRODUCT_COPY_FILES += frameworks/native/data/etc/android.hardware.vulkan.level-0.xml:system/etc/permissions/android.hardware.vulkan.level.xml
  endif
endif
...
PRODUCT_COPY_FILES += device/mediatek/mt6797/init.sensor_bio.rc:root/init.sensor_bio.rc
endif

ifneq ($(strip $(MTK_SENSOR_BIO)),yes)
PRODUCT_COPY_FILES += device/mediatek/mt6797/init.sensor.rc:root/init.sensor.rc
endif
...
PRODUCT_COPY_FILES += $(LOCAL_PATH)/thermal.wfd.6797.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/.thermal_policy_00:mtk
PRODUCT_COPY_FILES += $(LOCAL_PATH)/thermal.pip.6797.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/.thermal_policy_01:mtk
PRODUCT_COPY_FILES += $(LOCAL_PATH)/thermal.fdvrgis.6797.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/.thermal_policy_02:mtk
PRODUCT_COPY_FILES += $(LOCAL_PATH)/thermal.vsdof.6797.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/.thermal_policy_03:mtk
ifeq ($(MTK_CAM_STEREO_DENOISE_SUPPORT),yes)
    PRODUCT_COPY_FILES += $(LOCAL_PATH)/thermal.BMdenoise.6797.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/.thermal_policy_04:mtk
endif
...
PRODUCT_COPY_FILES += device/mediatek/mt6797/media_codecs.xml:system/etc/media_codecs.xml:mtk

ifneq ($(MTK_BASIC_PACKAGE), yes)
    ifeq ($(strip $(MTK_AUDIO_CODEC_SUPPORT_TABLET)), yes)
        PRODUCT_COPY_FILES += device/mediatek/mt6797/media_codecs_mediatek_audio_tablet.xml:system/etc/media_codecs_mediatek_audio.xml:mtk
    else
        PRODUCT_COPY_FILES += device/mediatek/mt6797/media_codecs_mediatek_audio_phone.xml:system/etc/media_codecs_mediatek_audio.xml:mtk
    endif
else
    PRODUCT_COPY_FILES += device/mediatek/mt6797/media_codecs_mediatek_audio_basic.xml:system/etc/media_codecs_mediatek_audio.xml:mtk
endif

PRODUCT_COPY_FILES += device/mediatek/mt6797/media_codecs_mediatek_video.xml:system/etc/media_codecs_mediatek_video.xml:mtk
PRODUCT_COPY_FILES += device/mediatek/mt6797/media_codecs_performance.xml:system/etc/media_codecs_performance.xml:mtk
PRODUCT_COPY_FILES += device/mediatek/mt6797/mtk_omx_core.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk
...
PRODUCT_COPY_FILES += device/mediatek/mt6797/media_codecs_mediatek_video_svp.xml:system/etc/media_codecs_mediatek_video_svp.xml
endif

ifeq ($(MTK_CLEARMOTION_SUPPORT),yes)
PRODUCT_COPY_FILES += device/mediatek/mt6797/mtk_clear_motion.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_clear_motion.cfg:mtk
endif

#Audio config
PRODUCT_COPY_FILES += device/mediatek/mt6797/audio_device.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_device.xml:mtk
...
#Audio config
PRODUCT_COPY_FILES += device/mediatek/mt6797/audio_device_param/DSM_config.xml:$(TARGET_COPY_OUT_VENDOR)/etc/DSM_config.xml:mtk
PRODUCT_COPY_FILES += device/mediatek/mt6797/audio_device_param/DSM.xml:$(TARGET_COPY_OUT_VENDOR)/etc/DSM.xml:mtk
...
ifeq ($(strip $(MICROTRUST_TEE_SUPPORT)), yes)
  ...
  #PRODUCT_COPY_FILES += vendor/mediatek/proprietary/trustzone/microtrust/source/platform/mt6797/teei/alipayapp:$(TARGET_COPY_OUT_VENDOR)/thh/alipayapp:mtk
